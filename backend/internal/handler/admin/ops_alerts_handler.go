...
var validOpsAlertMetricTypes = []string{
	...
	"account_balance_low_count",
	"account_balance_low_ratio",
	"account_balance_probe_failed_count",
	"account_balance_stale_count",
	"account_balance_unknown_count",
	"group_balance_low_count",
	"group_balance_low_ratio",
