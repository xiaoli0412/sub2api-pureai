...
func SetupRouter(
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, astrBotAuth, astrBotSignature, astrBotRateLimit, astrBotRead, astrBotWrite, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	routes.RegisterAstrBotRoutes(v1, h, adminAuth, auditLog, settingService, panelRateLimiter, astrBotAuth, astrBotSignature, astrBotRateLimit, astrBotRead, astrBotWrite)
