...
func (r *usageBatchLogRepoStub) GetChannelMonitorLogStatusBatch(context.Context, []ChannelMonitorLogTarget, time.Duration) (map[int64]map[string]*ChannelMonitorLogStatus, error) {
	return map[int64]map[string]*ChannelMonitorLogStatus{}, nil
}
