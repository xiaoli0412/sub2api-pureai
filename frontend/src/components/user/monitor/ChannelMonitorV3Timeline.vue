<!--
  ...
  Behaviour and visual design are preserved; the availability colour ladder is
  now supplied by monitorFormat.availabilityBarClass so it stays in lockstep
  with the card.
-->
<template>
