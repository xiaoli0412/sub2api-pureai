export default {
    settings: {
      ...
      payment: {
        ...
        field_alipaySignTypeHint: '签名算法，默认 RSA2（推荐）。RSA 仅老式密钥使用。',
        field_alipayGatewayHint: '网关地址：生产环境 https://openapi.alipay.com/gateway.do，沙箱 https://openapi-sandbox.dl.alipaydev.com/gateway.do。',
        field_alipayEncryptKeyHint: '内容加密密钥（AES），支付宝开放平台“接口加密方式”开启后填写；不使用加密时留空。',
        field_alipayAppCertHint: '应用公钥证书 PEM 全文（可选）。使用证书模式时填入，与“应用公钥”二选一。',
        field_alipayPublicCertHint: '支付宝公钥证书 PEM 全文（可选）。证书模式下用于验签。',
        field_alipayRootCertHint: '支付宝根证书 PEM 全文（可选）。证书模式下用于校验证书链。',
        field_cid: '支付渠道 ID',
