export default {
    accounts: {
      ...
      balance: {
        ...
        value: 'Balance',
        status: 'Status',
        updated: 'Last successful update',
        currencies: 'Balances by currency',
        unsupported: 'Unsupported',
        unsupportedHint: 'This provider does not expose a supported balance endpoint. The displayed multiplier is your local billing multiplier, not an upstream balance.',
        stale: 'The last successful balance is stale. Probe again to refresh it.',
        staleShort: 'stale'
      },
