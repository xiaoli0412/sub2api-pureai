export default {
    ...
    riskControl: {
      ...
      keywordImportTitle: 'Import keyword TXT',
      keywordImportHint: 'Upload a UTF-8 text file. Lines beginning with [category] group the preview; blank lines and # comments are ignored. Category names may be English, Chinese, or mixed.',
      keywordImportChooseFile: 'Choose TXT file',
      keywordImportNoFile: 'No file selected',
      keywordImportFileLimit: 'TXT only · max {size}',
      keywordImportApiOnly: 'API-only strategy is active. The keyword list is not consulted, so TXT import is disabled until you choose Keyword only or Keyword + API.',
      keywordImportPreview: 'Import preview',
      keywordImportSummary: '{count} keywords in {categories} categories · {duplicates} duplicate lines skipped',
      keywordImportMode: 'Import mode',
      keywordImportAppend: 'Append',
      keywordImportReplace: 'Replace',
      keywordImportCategoryCount: '{count} keywords',
      keywordImportResultCount: 'After import: {count} unique keywords (limit {max})',
      keywordImportTooLong: ' {count} lines exceed the {max}-character limit and must be fixed before import.',
      keywordImportApply: 'Apply import',
      keywordImportApplied: 'Imported {count} keywords into the editor',
      keywordImportUncategorized: 'Uncategorized',
      keywordImportTextOnly: 'Choose a .txt file.',
      keywordImportFileTooLarge: 'The TXT file is larger than {size}.',
      keywordImportEmpty: 'The file contains no valid keyword lines.',
      keywordImportReadFailed: 'The TXT file could not be read.',
      blockedKeywordsTooMany: 'You can save at most {max} unique keywords.',
      blockedKeywordTooLong: 'Each keyword must be no longer than {max} characters.',
