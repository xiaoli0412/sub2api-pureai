export default {
    settings: {
      ...
      payment: {
        ...
        field_alipaySignTypeHint: 'Signature algorithm, default RSA2 (recommended). RSA is for legacy keys only.',
        field_alipayGatewayHint: 'Gateway URL: production https://openapi.alipay.com/gateway.do, sandbox https://openapi-sandbox.dl.alipaydev.com/gateway.do.',
        field_alipayEncryptKeyHint: 'Content encryption key (AES); set only if "Interface Encryption" is enabled in the Alipay open platform. Leave empty otherwise.',
        field_alipayAppCertHint: 'Application public cert PEM (optional). Used in certificate mode; mutually exclusive with the public key.',
        field_alipayPublicCertHint: 'Alipay public cert PEM (optional). Used in certificate mode for signature verification.',
        field_alipayRootCertHint: 'Alipay root cert PEM (optional). Used in certificate mode to validate the cert chain.',
