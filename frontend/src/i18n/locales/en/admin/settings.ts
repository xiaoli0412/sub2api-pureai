    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          mode: 'Monitor mode',
          modeHint: 'Default is V1 (active probes). Switch to V2 or V3 only when you want passive aggregation; only one implementation can be active at a time.',
          modeV3: 'V3 group console',
          modeV2: 'V2 passive monitoring',
          modeV1: 'V1 active probes',
          modeV3Hint: 'Shares the V2 passive pipeline: group-scoped cards for availability, cache rate and TTFT, counting only real streaming text traffic. No probe traffic; V1 probes stop.',
